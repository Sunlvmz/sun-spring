...
public abstract class AbstractApplicationContext implements ApplicationContext {
     ...
     * @throws Exception
     */
    protected abstract void loadBeanDefinitions(DefaultBeanFactory beanFactory) throws Exception;
     ...
     * @throws Exception
     */
    protected void registerBeanPostProcessors(DefaultBeanFactory beanFactory) throws Exception {
    ...
    public Map getBeanDefinitionMap(){
